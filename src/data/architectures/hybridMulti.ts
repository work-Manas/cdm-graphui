...
export function buildHybridMulti(): Architecture {
  ...
  const edges = [
    makeFlowEdge({
      ...
      throughput: { current: 880, peak: 1500 },
      status: "active",
    }),
    makeFlowEdge({
      source: apiGw.id,
      ...
      ports: [{ protocol: "HTTPS", port: 443 }],
      label: "Invoke :443",
      throughput: { current: 420, peak: 980 },
      status: "active",
    }),
    makeFlowEdge({
      source: apiGw.id,
      ...
      throughput: { current: 360, peak: 820 },
      status: "active",
    }),
    makeFlowEdge({
      ...
      throughput: { current: 290, peak: 720 },
      status: "active",
    }),
    makeFlowEdge({
      ...
      ports: [{ protocol: "HTTPS", port: 443 }],
      label: "HTTPS :443",
      throughput: { current: 410, peak: 950 },
      status: "active",
    }),
    makeFlowEdge({
      source: aurora.id,
      ...
      throughput: { current: 95, peak: 220 },
      status: "idle",
    }),
  ];
