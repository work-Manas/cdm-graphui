...
export function buildThreeTierWeb(): Architecture {
  ...
  const edges = [
    makeFlowEdge({
      ...
      ports: [{ protocol: "HTTPS", port: 443 }],
      label: "HTTPS :443",
      throughput: { current: 820, peak: 1400 },
      status: "active",
    }),
    makeFlowEdge({
      source: alb.id,
      ...
      ports: [{ protocol: "HTTP", port: 8080 }],
      label: "HTTP :8080",
      throughput: { current: 280, peak: 600 },
      status: "active",
    }),
    makeFlowEdge({
      source: alb.id,
      ...
      ports: [{ protocol: "HTTP", port: 8080 }],
      label: "HTTP :8080",
      throughput: { current: 290, peak: 620 },
      status: "active",
    }),
    makeFlowEdge({
      source: alb.id,
      ...
      ports: [{ protocol: "HTTP", port: 8080 }],
      label: "HTTP :8080",
      throughput: { current: 180, peak: 540 },
      status: "degraded",
    }),
    makeFlowEdge({
      source: webA.id,
      ...
      ports: [{ protocol: "TCP", port: 6379 }],
      label: "TCP :6379",
      throughput: { current: 320, peak: 760 },
      status: "active",
    }),
    makeFlowEdge({
      source: webB.id,
      ...
      ports: [{ protocol: "TCP", port: 6379 }],
      label: "TCP :6379",
      throughput: { current: 295, peak: 700 },
      status: "active",
    }),
    makeFlowEdge({
      source: webC.id,
      ...
      ports: [{ protocol: "TCP", port: 6379 }],
      label: "TCP :6379",
      throughput: { current: 95, peak: 480 },
      status: "degraded",
    }),
    makeFlowEdge({
      source: webA.id,
      ...
      ports: [{ protocol: "TCP", port: 5432 }],
      label: "TCP :5432",
      throughput: { current: 410, peak: 920 },
      status: "active",
    }),
    makeFlowEdge({
      source: webB.id,
      ...
      ports: [{ protocol: "TCP", port: 5432 }],
      label: "TCP :5432",
      throughput: { current: 380, peak: 880 },
      status: "active",
    }),
    makeFlowEdge({
      source: webC.id,
      ...
      ports: [{ protocol: "TCP", port: 5432 }],
      label: "TCP :5432",
      throughput: { current: 140, peak: 640 },
      status: "degraded",
    }),
    makeFlowEdge({
      source: aurora.id,
      ...
      throughput: { current: 60, peak: 200 },
      status: "active",
    }),
    makeFlowEdge({
      source: cloudfront.id,
      ...
      ports: [{ protocol: "HTTPS", port: 443 }],
      label: "Origin :443",
      throughput: { current: 42, peak: 280 },
      status: "active",
    }),
    makeFlowEdge({
      source: webA.id,
